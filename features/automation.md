...
| Dynamic quest endpoint | Runs the selected expedition using endpoint parsed from page data. |
...
| MOE refill endpoint | Uses Energy Refill Manager if energy is insufficient. |
...
| Dynamic Abyss endpoints | Join, continue, attack, gather, escape, or complete Abyss using page data. |
...
| `temple.increase_worship_count_endpoint` | Buys extra worship with confirmation. |

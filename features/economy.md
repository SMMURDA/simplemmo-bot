...
| Diamond refill endpoint | Refills energy using diamonds with confirmation. |
...
| `travel.potion.use_endpoint` | Uses selected potion quantity from dynamic page data. |
